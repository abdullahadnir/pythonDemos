...
class Github:
    ...
    def signIn(self):
        ...
        login = self.browser.find_element(By.XPATH,"//*[@id='login']/div[4]/form/div/input[12]")
        login.click()
    
    def loadFollowers(self):
         items = self.browser.find_elements(By.CSS_SELECTOR,".d-table-cell.col-9")
         for i in items:
