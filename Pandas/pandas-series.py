...
# result = pandas_series[:2]             #ilk 2 elemanı al
# result = pandas_series[-2:]            # son 2 elemanı al
# result = pandas_series['a']
# result = pandas_series['d']
# result = pandas_series[['a','c']]      # a ile c indeksini verir
# result = pandas_series[[0,2]]          # 0 ile 2. indeksi verir
# result = pandas_series[['a','c','e']]
# result = pandas_series.ndim              # kaç boyutlu diye öğrenir
# result = pandas_series.dtype
# result = pandas_series.shape              # kaça kaçlık liste olduğunu söyler
